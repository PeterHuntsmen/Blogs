...
<br />
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BlogsConnectionString %>" SelectCommand="SELECT [blog_id], [blog_date], [blog_title] FROM [blogs] WHERE (([user_id] = @user_id) AND ([comment_num] = @comment_num))">
                                                <SelectParameters>
                                                    <asp:SessionParameter Name="user_id" SessionField="user" Type="String" />
                                                    <asp:Parameter DefaultValue="0" Name="comment_num" Type="Int32" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
