...
<body class="templatemo-bg-gray">
	<h1 class="margin-bottom-15">Create A New Account</h1>
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" runat="server" method="post">
				<div class="form-inner">
			        ...
			        <div class="form-group">
			          <div class="col-md-12">
			            ...
			            <a href="Login.aspx" class="pull-right">Login</a>
			          </div>
			        </div>	
				</div>				    	
		      </form>		      
