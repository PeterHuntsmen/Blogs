	...
	<section id="page">
				...
				<div id="sidebar" class="sidebar">
					<div class="sidebar-menu nav-collapse">
						...
						<!-- SIDEBAR MENU -->
						<ul>
							<li><a class="active" href="Index.aspx"><span class="menu-text">主页</span></a></li>
									...
									<div class="box-body">
										...
										<div class="emailHeader row">
											<div class="emailTitle">
											  <div class="col-md-10">
												  <form class="form-inline hidden-xs" runat="server" method="post">
													 <div class="input-group input-medium">
														<input name="keyword" type="text" class="form-control" placeholder="Search Inbox">
...
<br />
                                                   ...
                                                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BlogsConnectionString %>" SelectCommand="SELECT [blog_date], [blog_title], [blog_body] FROM [blogs] WHERE ([blog_title] = @blog_title)">
                                                       <SelectParameters>
                                                           <asp:SessionParameter Name="blog_title" SessionField="keyword" Type="String" />
                                                       </SelectParameters>
                                                   </asp:SqlDataSource>
                                                </div>
											</div>
